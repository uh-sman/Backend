...
const SuperAdminSignUpController = asyncHandler(async (req,res ,next) => {
    try{
<<<<<<< HEAD:Backend/.history/controllers/admin/admin_20231108103710.js
        const superAdminRegisterService = await superAdminRegister(req.body)
=======
        const superAdminRegisterService = await superAdminRegister(req)
>>>>>>> a62fa0b843429228bb5a747b0c081c693bafbc3f:.history/controllers/admin/admin_20231108103710.js
...
const createAdminController = asyncHandler ( async (req,res) => {
    const createAdminService = await createAdmin(req)
