...
<<<<<<< HEAD:Backend/.history/controllers/admin/adminFunc/index_20231108055753.js
...
=======
  ...
  // let sRole = "superAdmin";
>>>>>>> a62fa0b843429228bb5a747b0c081c693bafbc3f:.history/controllers/admin/adminFunc/index_20231108055753.js
...
const createAdmin = async (data) => {
  ...
  if (user.role !== "admin" && (await user.updateOne({ role: "admin" }))) {
    return (data = {
      message: "SUCCESSFUL",
    });
  } else {
...
const updateAdmin = async (data) => {
  ...
  const updatedAdmin = await User.findByIdAndUpdate(userId, updates, {
    new: true,
  });
  if (!updatedAdmin) {
    return (data = {
